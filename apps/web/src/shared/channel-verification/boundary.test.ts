...
/**
 * Channel verification is platform (ADR 0009) and publishes no interface. Each
 * fence here is a rule the structure or that decision states; a rule with no
 * check erodes.
 */

const SRC = join(process.cwd(), "src");
const CAPABILITY = join(SRC, "shared", "channel-verification");
const ALIAS = "@shared/channel-verification";
...
describe("the capability's public surface", () => {
...
describe("what the capability holds", () => {
