...
import type { JourneyRepository, JourneyState } from "./journey.types";
...
/**
 * Where the reader belongs, asked once. At `verify` the move is the question:
 * only the server knows whether a challenge is outstanding, and refusing it is
 * how it says no.
 */
