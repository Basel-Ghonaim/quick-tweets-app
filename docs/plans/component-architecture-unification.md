...
- **E3 — A folder exists when it has content.** §3.3 states where a responsibility *goes*; it does not mandate empty directories. Imposing the full layout on the smallest component is the reserved-vocabulary mistake in another form.
