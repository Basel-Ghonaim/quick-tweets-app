...
| **4 — Generalization & second consumer** | Cross-principal authority + `TweetMedia` schema + reference coordination + tweet-compose media. | M7, M8, M8a, M9 |
