...
> **Scope:** The server-side capability at `apps/api/src/modules/auth/password-reset/`. Frontend behaviour is not described here: how the recovery screens compose it is the [authentication feature](../features/authentication.md)'s.
> **Version:** 1.4
