...
Giving recovery, profile and the journey documents of their own ([Finding 0034](../resolved/0034-four-capabilities-are-described-by-a-document-that-does-not-own-them.md)) meant checking what each of them points at. **Eight things they point at, or that the work relied on, are missing from the documentation.** They are grouped here because each is the same kind of gap, a subject with no home or a fact its owner does not state, and none of them was the split's to fill.
