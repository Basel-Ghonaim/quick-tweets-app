...
| 7 | `src/docs/Principles/GitHub.md` | **Merge** | `docs/development/workflow.md` | Git/branch/commit/PR/issue conventions consolidated into the single workflow document. |
| 8 | `src/docs/Principles/Ai_ImplementationWorkflow.md` | **Merge** | `docs/development/workflow.md` | AI workflow steps consolidated into the single workflow document. |
| 9 | `src/docs/Principles/MyWorkingPrinciples.md` | **Merge** | `docs/development/workflow.md` | SOLID, naming, and coding standards become the working-principles section. Mechanism-specific subsections (JWT, RTK Query, schema-form, API client, etc.) are **owned by platform docs** and are linked, not copied. |
...
| Git / AI / coding conventions | `docs/development/workflow.md` | GitHub.md, Ai_ImplementationWorkflow.md, MyWorkingPrinciples.md |
...
5. **Principles vs. mechanisms.** `MyWorkingPrinciples.md` mixes cross-cutting standards (SOLID, naming) with mechanism descriptions. **Resolution:** standards → `development/workflow.md`; mechanisms are owned by platform docs and linked.
...
1. **Development & project docs (lowest risk, self-contained).**
   Build `docs/development/workflow.md` from `GitHub.md` + `Ai_ImplementationWorkflow.md` + `MyWorkingPrinciples.md` (standards only). Create `docs/project/overview.md` and `docs/project/glossary.md`.
...
| **Move** | 0 | — |
| **Merge** | 9 | `GitHub.md` → `development/workflow.md`; `Ai_ImplementationWorkflow.md` → `development/workflow.md`; `MyWorkingPrinciples.md` → `development/workflow.md`; `auth_context.md` → `features/authentication.md`; `rtk-query-strategy.md` → `frontend/state-and-data.md`; `shared-api-errors.md` → `frontend/error-handling.md` + `frontend/api-client.md`; `hooks/README.md` → `features/authentication.md`; `FileInput.md` → `frontend/design-system.md`; `schema-form/readme.md` → `frontend/forms.md` |
